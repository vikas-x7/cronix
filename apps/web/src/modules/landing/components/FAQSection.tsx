    ...
    <section className="w-full bg-white text-black py-12 lg:py-16 px-6 sm:px-12 lg:px-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div className="flex flex-col">
          <h2 className="text-3xl sm:text-5xl leading-tight tracking-[-1.5px] sm:tracking-[-1px] font-medium mb-4">
            Frequently Asked Questions
          </h2>
          <p className="text-black/70 text-sm sm:text-[16px] mb-8 max-w-md">
            Everything you need to know about scheduling, monitoring, and
            scaling your automated tasks with Cronix.
          </p>
          <button className="flex items-stretch w-fit group hover:opacity-80 transition-opacity">
        ...
        <div className="w-full">
          <div className="rounded-[5px] overflow-hidden w-full">
              ...
              {faqs.map((f, i) => (
                ...
                >
                  <div className="flex items-center justify-between py-3.5">
                    ...
                    <IoIosArrowDown
                      className={`ml-4 shrink-0 transition-transform duration-200 text-black/70 ${
